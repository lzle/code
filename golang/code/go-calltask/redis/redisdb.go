...
var (
	...
	LocalRedisConfig     = config.LocalRedisConfig
...
func Run() {
	...
	err := redisdb.connect("tcp", url, RedisConfig.Password)
	if err != nil {
		return
	}
	...
	err = localRedisdb.connect("tcp", localUrl, LocalRedisConfig.Password)
	if err != nil {
		return
	}
